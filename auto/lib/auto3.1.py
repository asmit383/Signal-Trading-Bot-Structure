...
def process_alert(body):
    ...
    if signal == 1:
        ...
        try:
            client.futures_create_order(symbol='BTCUSDT', side='BUY', type='MARKET', quantity=0.0015)
        ...
        if position_size != 0:
            close_position(position_size)
        try:
            client.futures_create_order(symbol='BTCUSDT', side='SELL', type='MARKET', quantity=0.0015)
